...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.dgc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API Blank Project",
				"API Rest", "Versão 1.0",
				"https://help.github.com/articles/github-terms-of-service/",
				new Contact("Daniel Cordeiro", "https://github.com/danielcordeiro", "dgodinhoc@gmail.com"),
				"Open Source", 
				"https://help.github.com/articles/github-terms-of-service/", 
